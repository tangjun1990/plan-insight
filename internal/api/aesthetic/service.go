...
func (s *Service) CancelCollection(userID uint, req *CancelCollectionRequest) error {
	...
	// 保存数据
	if err := s.db.Where("a_id = ?", aid).Where("user_id", userID).Delete(&UserCollection{}).Error; err != nil {
		return err
	}
